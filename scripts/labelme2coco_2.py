...
class labelme2coco(object):
    ...
    def data_transfer(self):
        ...
        for label in self.label:
            ...
            #self.catids[label[0]] = len(self.catids)
    ...
    def category(self, label):
        category = {}
        category["supercategory"] = label #label[0]
        category["id"] = self.catids[label] #len(self.categories)
        category["name"] = label #label[0]
        return category
    ...
    def annotation(self, points, label, num):
        ...
        annotation["category_id"] = self.catids[label] #label[0]  # self.getcatid(label)
